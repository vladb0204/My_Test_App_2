...
//        ViewModelProvider(this).get(CrimeDetailViewModel::class.java)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        crimeDetailViewModel.crimeLiveData.observe(viewLifecycleOwner,
            androidx.lifecycle.Observer { crime -> crime?.let {
                ...
                "myproject.kotlin.criminai_test_app_1.fileprovider", photoFile)
                updateUI()
            } }
        )
    }
    ...
    override fun onStart() {
        ...
        val titleWatcher = object : TextWatcher {
            ...
            override fun beforeTextChanged(sequence: CharSequence?, start: Int,
                                           count: Int, after: Int) {
                TODO("Not yet implemented")
            }

            override fun onTextChanged(sequence: CharSequence?, start: Int,
                                       count: Int, after: Int) {
